<div wire:ignore.self class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel"
    ...
    <div class="modal-dialog">
        <form action="{{ Route('dashboard.category.store') }}" method="post" id="formAddCategory">
            @csrf
                ...
                <div class="modal-body">
                    <div class="form-group" wire:ignore>
                        ...
                        <select required name="category[]" multiple style="width:100%"
                            class="form-control js-example-basic-single" id="inputCategory">
                        </select>
...
@push('scripts')
    <script>
        ...
        document.addEventListener('OpenModalCategory', event => {
            $('#editModal').modal('show');
        });

        document.addEventListener('CloseModalCategory', event => {
