...
@section('content')
    <div class="col-12 col-sm-12 p-2">
        <form id="form" method="post" action="{{ Route('dashboard.product.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="shadow">
                <div class="card-header bg-white d-flex justify-content-between">
                    Create Form
                    <div class="custom-control custom-switch custom-switch-md">
                        <input type="checkbox" @if (old('status') == 'publish') checked @endif name="status" value="publish"
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane form-pane fade show active" id="tabs-icons-text-1" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        is-invalid
                                        @enderror"
                                            placeholder="Input Product Price" value="{{ old('price') }}">
                                        @error('price')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @enderror">
                                                    ...
                                                    <option value="new" @if (old('kondisi') == 'new') selected @endif>New</option>
                                                    <option value="preloved" @if (old('kondisi') == 'preloved') selected @endif>Preloved</option>
                                                </select>
